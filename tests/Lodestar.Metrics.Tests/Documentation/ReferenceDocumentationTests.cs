...
namespace Lodestar.Metrics.Tests.Documentation;

/// <summary>
/// The gate of D7 and the linking rule of D9, over the two pages
/// <c>Lodestar.Metrics</c> declares covered.
/// </summary>
/// <remarks>
/// The engine and its own unit tests live with <c>Lodestar.Text</c>; what is here is
...
public sealed class ReferenceDocumentationTests
{
    ...
    public void Every_covered_namespace_is_documented()
    {
        IReadOnlyList<string> complaints = ReferenceDocumentation.Check(
            typeof(ConfusionMatrix).Assembly, "Lodestar.Metrics", Map, Root);
    ...
    public void Neither_page_covers_the_namespace_on_its_own()
    {
        ...
        File.WriteAllText(map, """
            {"root":[],"packages":{"Lodestar.Metrics":{"wiki":"Metrics","pages":[],
             "covered":{"Lodestar.Metrics":"docs/reference/metrics/classification.md"}}}}
            """);
    ...
    [Fact]
    public void The_map_declares_every_directory()
    {
        ...
        Assert.Contains("docs/reference/metrics/clustering\"", map, StringComparison.Ordinal);
    }
}
