...
//     (https://snowballstem.org/algorithms/<language>/stop.txt), retrieved
//     2026-08-05. Do not edit by hand: rerun the script.
//
//     Copyright (c) 2001, Dr Martin Porter
//     Copyright (c) 2002, Richard Boulton
//     The Snowball lists are covered by the 3-clause BSD License; see NOTICE.
//
//     Word order follows the source file, so a reviewer can diff the two.
//     See docs/decisions/0010-stop-word-list-provenance.md.
// </auto-generated>
...
public static partial class StopWords
{
    ...
    public static IReadOnlyCollection<string> French { get; } = new HashSet<string>(StringComparer.Ordinal)
    {
    ...
    public static IReadOnlyCollection<string> German { get; } = new HashSet<string>(StringComparer.Ordinal)
    {
    ...
    public static IReadOnlyCollection<string> Italian { get; } = new HashSet<string>(StringComparer.Ordinal)
    {
    ...
    public static IReadOnlyCollection<string> Portuguese { get; } = new HashSet<string>(StringComparer.Ordinal)
    {
    ...
    public static IReadOnlyCollection<string> Spanish { get; } = new HashSet<string>(StringComparer.Ordinal)
    {
