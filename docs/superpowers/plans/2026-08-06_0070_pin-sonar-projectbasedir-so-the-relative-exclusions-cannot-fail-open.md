...
- [x] **Step 1: Find the most recent successful analysis run**

```bash
gh run list --workflow sonarcloud.yml --limit 5
```

- [x] **Step 2: Extract the base directory from its log**
...
- [x] **Step 4: Read the scanner's own warning, and quote it in the PR**
...
- [x] **Step 2: `$GITHUB_WORKSPACE`, not a literal and not `.`**
...
- [x] **Step 3: Comment what it anchors**
...
- [x] **Step 1: Compare the base directory in the new run's log**
...
- [x] **Step 2: Confirm nothing was re-keyed**
...
- [x] **Step 3: Confirm the exclusions still apply**
