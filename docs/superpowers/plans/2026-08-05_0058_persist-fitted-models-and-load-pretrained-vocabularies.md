...
- [x] **Step 1: Add `System.Text.Json`, target-conditional**
...
- [x] **Step 2: A version field written by every artifact from the first commit**
...
- [x] **Step 3: A test per invariant, each with the exception it produces**
...
- [x] **Step 1: Persist options, vocabulary, idf and feature count**

- [x] **Step 2: `HashingVectorizer` too, even though it is stateless**
...
- [x] **Step 3: The round trip is bit-exact, not "within tolerance"**
...
- [x] **Step 1: `vocab.txt` — one token per line, id = line number**

- [x] **Step 2: `tokenizer.json` — WordPiece and Unigram**

Read `model.vocab`, `unk_token`, the continuation prefix, and the added/special
tokens.

- [x] **Step 3: `spiece.model` — a hand-written protobuf reader**

Pieces, scores, ids, **types**. The types are what let #63's control filter stop
guessing from ids.

- [x] **Step 4: Refuse, loudly, what cannot be reproduced**
...
- [x] **Step 5: Oracles from `tokenizers` and `sentencepiece`**
...
- [x] **Step 1: Measure the naive format**
...
- [x] **Step 5: Keep only what measures, and record what did not**
...
- [x] **Step 6: Report processor time as well as elapsed**
...
- [x] **Step 1: ADR 0011 — the format, the measurements, the rejections**

- [x] **Step 2: The `/* … */` disappears from both guides**

Replaced by a real one-liner. That placeholder was the issue's opening exhibit.

- [x] **Step 3: An `equivalence.md` row per loader, naming the Python call**

- [x] **Step 4: Say what the benchmark is not measuring**
...
- [x] **Step 6: Cover the overloads nobody was testing**
