...
- [ ] **Step 1: Confirm the scanner's window is the solution**
...
- [ ] **Step 2: Confirm no finding has ever been reported there**

Check the dashboard by file path. Expected: nothing under `samples/`.

- [ ] **Step 3: Note why this compounds**
...
- [ ] **Step 3: Record the exclusions and their reasons in the workflow**
...
- [ ] **Step 3: Revert, and confirm they disappear**

- [ ] **Step 4: Confirm the packaging gate still works**
...
- [ ] **Step 1: Read the first analysis of `samples/`**

This area has never been analysed, so whatever appears is a backlog rather than a
regression.

- [ ] **Step 2: Fix or triage each, and report the number**
