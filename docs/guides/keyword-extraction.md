...
ranks by the dominant eigenvector; the frozen
oracle corpus screens out every document where that column would have made a difference, before
freezing it. [Decision 0077](../decisions/0077-the-keyword-extractors-take-their-oracles-lists-and-not-their-own.md)
