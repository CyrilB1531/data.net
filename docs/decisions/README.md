...
All seventy carry `accepted`. None has been rejected or withdrawn — a status this table
...
of its own `## Done` section, and its status reads `accepted` like the other sixty-nine.
