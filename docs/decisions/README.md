...
| [`0051`](0051-the-save-paths-cost-is-the-buffer-not-the-encoding.md) | The save path's cost is the buffer, not the encoding | accepted | 2026-08-27 | amends [`0044`](0044-compression-belongs-to-the-caller.md): its `× save` column is re-based against a save 1.61× faster, and its decision stands strengthened. Extends [`0011`](0011-persistence-format.md)'s `> **#324 update:**` conclusion to the write direction |
